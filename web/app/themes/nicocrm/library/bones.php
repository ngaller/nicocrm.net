...
function bones_page_navi()
{
    ...
    if ($wp_query->max_num_pages > 1){
        $prev = get_previous_posts_link('Back...');
        $next = get_next_posts_link('More...');
    }
    if(empty($next))
        $next = '&nbsp;';
    if(empty($prev))
    ...
    $categories = wp_dropdown_categories([
        'class' => 'category-nav page-control',
        'show_option_none' => 'Go to...',
        'value_field' => 'slug',
        'echo' => false
    ]);
    $search_form = get_search_form(false);
    ?>
    <nav class="pagination t-o-1of3 t-2of3">
        <div class="col m-1of2 t-1of6"><?= $prev ?></div>
        <div class="col m-1of2 t-1of6"><?= $next ?></div>
        <div class="col m-all t-2of6">
